...
Scenario: O PO não possui pontos suficientes para criar uma nova Task
    Given que o PO possui a quantidade de pontos 100 para criar uma nova Task 300
    When o PO tenta criar uma nova Task com os detalhes: description "Desenvolver nova funcionalidade"; title "Nova Funcionalidade"; deadline "2024-10-01"; reward 300; numberOfMeetings 2; numberOfHuntersRequired 3
