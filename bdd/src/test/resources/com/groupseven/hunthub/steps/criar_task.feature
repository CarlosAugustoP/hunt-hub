...
Scenario: O PO possui uma ideia para uma nova Task e os pontos necessarios para cria-la
    ...
    When o PO cria uma nova Task com os detalhes: description "Desenvolver nova funcionalidade"; title "Nova Funcionalidade"; deadline "2024-10-01"; reward 300; numberOfMeetings 2; numberOfHuntersRequired 1; ratingRequired 3.5;
